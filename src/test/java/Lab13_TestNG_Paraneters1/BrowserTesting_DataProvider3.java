package  Lab13_TestNG_Paraneters1;
import CommonUtil.*;
...
@DataProvider(name = "23.08.2021")
public static Object[][] Authentication1() throws Exception {

	ExcelApiTest4 eat = new ExcelApiTest4();
	Object[][] testObjArray = eat.getTableArray("C:\\HTML Report\\OrangeHRM6\\23.08.2021.xlsx", "Sheet1");
	System.out.println(testObjArray.length);
	return (testObjArray);
}

	
	@Test(dataProvider = "23.08.2021")
