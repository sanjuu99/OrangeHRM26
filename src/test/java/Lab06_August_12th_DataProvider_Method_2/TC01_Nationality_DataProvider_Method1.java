...
public class TC01_Nationality_DataProvider_Method1 {
 ...
 static	WebDriver driver;
	...
	//Step1
	 @DataProvider(name = "Orange2")
	  public static Object[][] Test1() throws Exception {
	        ...
	        return new Object[][] { 
	        	{ "https://opensource-demo.orangehrmlive.com/","Admin", "admin123","Indians12711" },
	        	{ "https://opensource-demo.orangehrmlive.com/","Admin", "admin123","Indians12812" },
	        	{ "https://opensource-demo.orangehrmlive.com/","Admin", "admin123","Indians12913" }
	        	};
	  }
	...
	public void loginTest(String TestURL,String UserName,String Password,String Nationality_Text) throws Exception//Step3
	{
		...
		TC01_Nationality_DataProvider_Method1 T1 = new TC01_Nationality_DataProvider_Method1();
