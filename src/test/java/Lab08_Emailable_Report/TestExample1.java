package  Lab08_Emailable_Report;
import CommonUtil.*;
...
public class TestExample1
{
	...
	public void Test1() throws Exception {
		...
		Reporter.log("Pass- BeforeTest");  //This will not be printed in Emailable report.
	}
	...
	public void Test3() throws Exception {
		...
		driver.close();
		Reporter.log("Pass- AfterTest");  //This will not be printed in Emailable report. Which written @Test only be printed
	}
